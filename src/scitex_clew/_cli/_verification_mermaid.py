...
def mermaid(
    ...
    # There is no --db: clew reads THE store this host uses (host_store()),
    # so there is nothing to point at. Rendering another capsule's store is
    # a capability that went with the per-project database file.
